    ...
    public void run(){
        ...
        if(this.users_team){
            ...
            for(int i = 0; i < this.roster.size(); i++) {
                ...
                if(player.getGamesSat() > (this.schedule.size() / 2)) {
                ...
                if(player.did_retire()){
                    ...
                    Player fa = freeAgencyPool.getFreeAgent(this.users_team, null, 0);
                    this.roster.add(i, fa);

                    // Add the new rookie's salary to the cap
                    this.cap_hit += fa.getSalary();
                    ...
                    if(player.getContract().getLength() <= 0){
                        ...
                        if(s.next().equals("n")){
                            ...
                            Player fa = freeAgencyPool.getFreeAgent(this.users_team, player, 0);
                    ...
                    if(player.getContract().getLength() <= 0){
                        ...
                        if(overall < 12){
                            ...
                            if(r.nextInt(14) < overall){
                                ...
                                this.freeAgencyPool.getFreeAgent(this.users_team, player, 0);
                            }
                        } else {
